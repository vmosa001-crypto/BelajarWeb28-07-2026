...
async function getOrdersByEmail(email) {
  ...
  return all.filter(o => o.email && o.email.toLowerCase() === email.toLowerCase());
}

module.exports = { getProducts, getProduct, addProduct, addOrder, getOrders, getOrdersByEmail, updateProduct, updateOrder, isSheetsConfigured };
